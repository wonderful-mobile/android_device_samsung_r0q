...
echo 75 95 > /proc/sys/walt/sched_upmigrate
...
echo 1324800 > /sys/devices/system/cpu/cpufreq/policy0/walt/up_delay_freq
...
echo 673 > /sys/devices/system/cpu/cpufreq/policy0/walt/target_load_thresh
echo 0 > /sys/devices/system/cpu/cpu0/cpufreq/walt/pl

echo 2457600 > /sys/devices/system/cpu/cpufreq/policy4/walt/up_delay_freq
...
echo 917 > /sys/devices/system/cpu/cpufreq/policy4/walt/target_load_thresh

echo 2995200 > /sys/devices/system/cpu/cpufreq/policy7/walt/up_delay_freq
...
echo 963 > /sys/devices/system/cpu/cpufreq/policy7/walt/target_load_thresh
